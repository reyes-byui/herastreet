  ...
  <div className="w-screen bg-white">
    <div className="flex flex-col md:flex-row items-center gap-6 md:gap-0 max-w-5xl mx-auto px-8 py-12">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center items-start px-4">
            <LazyText as="a" href="https://www.grandyacoffee.com" target="_blank" rel="noopener noreferrer" className="text-2xl font-bold mb-2 bg-gradient-to-r from-[#303030] via-[#615D5D] to-[#C7C7C7] bg-clip-text text-transparent transition-all duration-300 hover:from-[#7A7A7A] hover:via-[#C0C0C0] hover:to-[#f8f8f8] hover:bg-gradient-to-l">GRANDYA COFFEE - Siem Reap, Cambodia</LazyText>
